...
const int DIGITAL4_IREG = 80;
const int DIGITAL5_IREG = 90;
...
void setup() {
    ...
    mb.addIreg(DIGITAL4_IREG);
    mb.addIreg(DIGITAL5_IREG);
...
void loop() {
   ...
   digitalWrite(digitalPin2, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin3, mb.Coil(DIGITAL1_COIL));
   analogWrite(digitalPin4, mb.Coil(DIGITAL1_COIL));
   analogWrite(digitalPin5, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin6, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin7, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin8, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin9, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin10, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin11, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin12, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin13, mb.Coil(DIGITAL1_COIL));
   digitalWrite(digitalPin14, mb.Coil(DIGITAL1_COIL));
