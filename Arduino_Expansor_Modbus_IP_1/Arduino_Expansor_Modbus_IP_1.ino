...
void loop() {
   ...
   Output1=map(Input1,0,100,0,255);
   
   Input2= mb.Hreg(DIGITAL5_HREG);
   Output2=map(Input2,0,100,0,255);
   ...
   analogWrite(digitalPin4, Output1);
   analogWrite(digitalPin5, Output2);
