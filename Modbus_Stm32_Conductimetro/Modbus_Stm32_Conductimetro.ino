...
// Used Pins
const int SensorPin = PB0;
const int TxenPin = PB12; // -1 disables the feature, change that if you are using an RS485 driver, this pin would be connected to the DE and /RE pins of the driver.
