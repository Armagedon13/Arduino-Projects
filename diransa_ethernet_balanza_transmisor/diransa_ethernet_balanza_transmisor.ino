...
uint8_t broadcastAddress[] = {0x24, 0x6F, 0x28, 0x3C, 0x1D, 0x00}; // MAC del segundo ESP32
...
void setupOTA() {
  ...
  ArduinoOTA.setHostname("esp32-transmitter-OTA");
  ArduinoOTA.onStart([]() {
    String type;
...
void setup() {
  Serial.begin(115200);
  pinMode(greenLedPin, OUTPUT_PULLDOWN);
  pinMode(redLedPin, OUTPUT_PULLDOWN);
  pinMode(activityLedPin, OUTPUT_PULLDOWN);
