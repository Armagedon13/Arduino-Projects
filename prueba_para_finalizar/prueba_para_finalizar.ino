...
const int analogPin=0;   // Which pin will be the input of the Voltage-Divider
...
//RPM
pulso_valor = pulseIn (5, HIGH); 
pulso_valor_t = pulso_valor*2;
RPM = 60000000/pulso_valor_t;
  if(RPM < 10){
