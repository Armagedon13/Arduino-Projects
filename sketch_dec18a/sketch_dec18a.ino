...
void setup() {
  ...
  Serial.begin(9600, SERIAL_8E1 ); // 19200 baud, 8-bits, even, 1-bit stop
  slave.start(); //Abre la comunicación como esclavo
...
void loop() {
  ...
  state = slave.poll( au16data, 16); //Parámetros: Tabla de registros para el intercambio de info
